      ...
      <div class="row">
        ...
        <div class="col-md-5 col-md-push-2">
          <div class="form">
            ...
            <form action="{{route('message.save')}}" method="post" role="form" class="contactForm">
              @csrf
              ...
              <div class="form-group">
                <input type="email" class="form-control" name="mail" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" />
                <div class="validation"></div>
              </div>
              <div class="form-group">
